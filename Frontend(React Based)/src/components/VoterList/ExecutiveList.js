...
const voterListUrl = url.executiveListUrl;
const VoterDeleteUrl = url.deleteExecutiveUrl;


class ExecutiveListTable extends Component {
    state = {
        searchText: '',
        voters:[]
      };
    ...
    render() {
        ...
        const columns = [
          ...
          return <Table columns={columns} dataSource={this.state.voters} rowKey={record => record.membershipId}/>;
    }
}

export default ExecutiveListTable;