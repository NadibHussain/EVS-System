...
class PrintBallotHeader extends Component {
    state={
    ...
    render() {
        ...
        return (
            ...
            <Row style={{backgroundColor: 'white'}}>
                    {/* <Col span={3}></Col> */}
                    <Col span={6} >
                        <Avatar src={logo} shape="square" size={80} style={{ display:'flex', marginLeft:'auto', marginRight:'auto'}}> </Avatar>
                    </Col>
                    <Col span={12} style={{textAlign: 'center', fontSize:18}}>
                ...
                <Col span={24}>
                    <Card >
                        ...
                        <li><b> Collect the printed copy of your voted ballot paper from printer after confirmation  and drop it to the ballot box. </b></li> */}
                            ...
                            {this.props.totalCandidate>5 ? <li>Swipe up using touch to see all candidates </li>: ''}
...
export default PrintBallotHeader; 