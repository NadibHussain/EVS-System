...
import p2 from '../../images/voter_reg.jpg';
...
const addNewVoterUrl = url.addNewVoterUrl;
const initialState = {
  voter:{
    name:""
  },
...
class AddNewVoter extends Component {
...
onFormSubmit(e){
  e.preventDefault()
    ...
    formData.append('voter', JSON.stringify(this.state.voter))
          ...
          {/* Column */}
            <Col span={10} >
              <form onSubmit={this.onFormSubmit}>
                ...
                <h1 style = {inputFeild}> Add New Voter </h1>
                  <div style = {inputFeild}>
                      <label className= "float-left font-weight-bold"> Voter Name </label>
                      <Input
                          name = "name" 
                  ...
                  <div style = {inputFeild}>
                    ...
                    <div  style = {inputFeild}>
                      <label className= "float-left font-weight-bold"> Upload a photo of the voter</label>
