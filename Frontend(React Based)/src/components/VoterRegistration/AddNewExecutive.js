...
const addNewVoterUrl = url.addNewExecutiveUrl;
...
class AddNewExecutive extends Component {
...
onFormSubmit(e){
  e.preventDefault()
    ...
    formData.append('executive', JSON.stringify(this.state.voter))
          ...
          {/* Column */}
            <Col span={10} >
              <form onSubmit={this.onFormSubmit}>
                ...
                <h1 style = {inputFeild}> Add New Executive </h1>
